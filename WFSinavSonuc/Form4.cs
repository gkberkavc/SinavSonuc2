...
namespace WFSinavSonuc
{
    public partial class Form4 : Form
    {
        ...
        public Form4(INotService notService,IKullanıcıService kullanıcıService)
        {
            InitializeComponent();
        ...
        private void dataGridView1_Click(object sender, EventArgs e)
        {
            ...
            if(dersnot!=null)
            {
                Form5 fm5 = new Form5(_notService,_kullanıcıService);
                fm5.NotId = Convert.ToInt32(dataGridView1.SelectedRows[0].Cells["NotId"].Value);
